 ...
 */
char *format_bin(va_list num, __attribute__((unused)) printing_format * format)
{
...
/**
 * format_hex - prints the lowercase hex representation of a number
 * @num: input integer
 * @format: the format to use to prepare the string
...
/**
 * format_Hex - prints the uppercase hex representation of a number
 * @num: input integer
 * @format: the format to use to prepare the string
 * Return: length of hex
 */
...
/**
 * format_oct - prints the octal representation of a number
 * @num: input integer
 * @format: the format to use to prepare the string
