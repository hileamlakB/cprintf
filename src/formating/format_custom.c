 ...
 */
char *format_rts(va_list list, __attribute__((unused)) printing_format * format)
{
...
/**
 * format_rot13 - a rot13 encrypted string from the va_list
 *@list: the variadic list to extract it from
 *@format: the format to use to prepare it
 *Return: a character pointer to the the encrypted string
 */
char *format_rot13(va_list list, __attribute__((unused)) printing_format * format)
{
...
/**
 * format_S - Non printable characters
 ...
 */
char *format_S(va_list l, __attribute__((unused)) printing_format * format)
{
